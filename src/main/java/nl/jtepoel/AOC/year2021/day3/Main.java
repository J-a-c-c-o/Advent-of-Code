package nl.jtepoel.AOC.year2021.day3;
...
public class Main {
    ...
    public List<String> getInput() {
        return utils.rotate(utils.getLines(Utils.LOCSRC + "/year2021/day3/input.txt"));
    }

    public List<String> getInput2() {
        return utils.getLines(Utils.LOCSRC + "/year2021/day3/input.txt");
    }
